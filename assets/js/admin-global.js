(function ($) {
    $(document).on('click', '#boom_wp_faq_schema_add_new', function () {
    ...
    $(document).on('click', '.boom_wp_faq_schema_faq_delete_button', function () {
    ...
    $(document).on('click', '#faq_toggler', function () {
        if ($(this).is(':checked')) {
            ...
            $('#boom_wp_faq_schema_add_new').removeClass('faq-disabled').attr('disabled', false);
        } else {
            $('.faqs-container').addClass('faq-disabled');
            $('#boom_wp_faq_schema_add_new').addClass('faq-disabled').attr('disabled', true);
